...
* [Elasticsearch](https://www.elastic.co/guide/en/elasticsearch/reference/7.9/install-elasticsearch.html) - version 7 (you can also install this via Docker, see below)
